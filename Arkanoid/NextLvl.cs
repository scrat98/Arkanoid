...
namespace Arkanoid
{
    public class NextLvl
    {
        ...
        public NextLvl(World world)
        {
            texture = world.game.Content.Load<Texture2D>("images/levelCompleted");
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, Vector2.Zero, new Rectangle(0, 0, texture.Width, texture.Height),
             Color.White, 0, Vector2.Zero, new Vector2(820f / texture.Width, 560f / texture.Height), SpriteEffects.None, 1); //NextLevel

            spriteBatch.Draw(Continue.texture, new Vector2(292, 360), new Rectangle(0, 0, Continue.texture.Width, Continue.texture.Height),
        ...
        public void PlaceCur()
        {
            ...
            if (mouse.Position.X >= 322 && mouse.Position.X <= 500 &&
            ...
            if (world.EffectsOn)
            {
                if (Continue.scale != Vector2.Zero && !(world.oldStateMouseMove.Position.X >= 322 && world.oldStateMouseMove.X <= 500 &&
