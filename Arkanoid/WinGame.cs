...
namespace Arkanoid
{
    public class WinGame
    {
        ...
        public WinGame(World world)
        {
            texture = world.game.Content.Load<Texture2D>("images/WinGame");
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, Vector2.Zero, new Rectangle(0, 0, texture.Width, texture.Height),
             Color.White, 0, Vector2.Zero, new Vector2(820f / texture.Width, 560f / texture.Height), SpriteEffects.None, 1); //WinGame
            ...
            text = String.Format("Score is {0}", world.score);
        ...
        public void PlaceCur()
        {
            ...
            else NewGame.scale = Vector2.Zero; //NewGame
